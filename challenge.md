...
An important part of code reviews is emphasis on code understandability. Let's break this down into two parts.

First, code design. Design complexity should be as simple as possible, subject to the problem constraints. More complex solutions are harder for others (and yourself months later) to follow. Simpler designs ensure others can quickly understand what your code is doing and how to use it effectively.

Second, documentation. All code should be properly documented, and formatting should follow PEP8 or other specified design standards. Proper documentation allows others to quickly read and understand code, making maintainence easier.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

Great question! Designing software in different environments is difficult. Time is often wasted on bugs that stem from differences in environments.

Docker containers and similar tools provide a solution. Containers allow the creation of a specific virtual environment for development and testing. The environment configuration can be as simple or as complex as desired.

Further, containers free you from the constraints of phyiscal or virtual machines. Multiple containers can be configured on the same machine, each configured with a unique environment.
